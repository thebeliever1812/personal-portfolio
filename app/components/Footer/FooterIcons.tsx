...
const FooterIcons: React.FC = () => {
    return (
        <div className="flex items-center gap-4">
            <a
                href="https://x.com/BasirAhmad1812"
                target="_blank"
                rel="noopener noreferrer"
                className="social-button relative w-10 h-10 rounded-full group cursor-pointer"
                aria-label="Visit Basir Ahmad&apos;s X (Twitter) profile"
            >
                <div
            ...
            <a
                href="https://github.com/thebeliever1812"
                target="_blank"
                rel="noopener noreferrer"
                className="social-button relative w-10 h-10 rounded-full group cursor-pointer"
                aria-label="Visit Basir Ahmad&apos;s GitHub profile"
            >
                <div
                    className="floater w-full h-full absolute top-0 left-0 bg-white rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
                ></div>
            ...
            <a
                href="https://www.linkedin.com/in/basir-ahmad-1a5851210/"
                target="_blank"
                rel="noopener noreferrer"
                className="social-button cursor-pointer relative w-10 h-10 rounded-full group"
                aria-label='Visit Basir Ahmad&apos;s LinkedIn profile'
            >
                <div
            ...
            <a
                ...
                aria-label="Send Email to Basir Ahmad"
            >
                <div
