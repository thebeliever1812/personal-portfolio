            ...
            <ul className='lg:flex gap-10 justify-center overflow-hidden grid grid-cols-3 md:grid-cols-4 justify-items-center content-center'>
                {
                    Object.entries(skills).map(([skill, icon]) =>
                        <li key={skill} className='w-20 lg:h-64 lg:rounded-t-full lg:rounded-b-none rounded-full p-1 lg:bg-[#330080] relative transition-transform duration-500 lg:hover:-translate-y-10 lg:hover:scale-105 lg:top-12 group'>
