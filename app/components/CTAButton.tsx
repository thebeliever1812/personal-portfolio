...
const CTAButton: React.FC<Props> = ({ path, children }) => {
    return (
        <Link href={path}>
            <button className="relative inline-flex items-center gap-3 font-semibold text-white whitespace-nowrap rounded-full pr-3.5 pl-3 py-2.5 bg-[#5200cc] hover:bg-black transition-colors duration-300 overflow-hidden group shadow-[0_0_15px_0_#5200cc] active:bg-black cursor-pointer">
                {/* Icon wrapper */}
